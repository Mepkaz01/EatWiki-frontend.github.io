    ...
    render() {
        ...
        return (
            <div>
                ...
                <div style={{marginBottom:'2px'}}><label  class="labelst" for="id1"> User ID: </label><input onChange={this.handleChange} type="text" name="userId" placeholder="userId" style={{ padding: '10px 10px',borderTopRightRadius:'5px', borderEndEndRadius:'5px',border:'0.25px solid', borderLeft:'0'}}/></div>  
                <div style={{marginBottom:'2px'}}><label  class="labelst" for="id1"> Email: </label><input onChange={this.handleChange} type="text" name="userEmail" placeholder="email" style={{ padding: '10px 10px',borderTopRightRadius:'5px', borderEndEndRadius:'5px',border:'0.25px solid', borderLeft:'0'}}/></div>  
